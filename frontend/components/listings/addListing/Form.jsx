...
const Form=()=>{
    ...
    const {values,errors,touched,handleBlur,handleChange,handleSubmit}=useFormik({
        ...
        onSubmit:(values,action)=>{
            axios.post(`${baseUrl}/listings`,values)
            .then((response)=>{
    ...
    return(
        <div className="absolute w-full  min-h-screen top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex justify-center items-center">
            <form onSubmit={handleSubmit} style={{maxHeight:'90vh',overflow:'auto'}} className="flex shadow-md shadow-pink-300/50 text-black scrollbar-style relative py-5 px-16 bg-gray-100 rounded-xl flex-col">
                ...
                <div className="mb-4 flex gap-8 m-auto">
                    ...
                    <div>
                        ...
                        <input name="price" value={values.price} onChange={handleChange} onBlur={handleBlur} type="text" id="first_name" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus focus:border-blue-500 w-96 p-2.5" placeholder="2500" required/>
